  ...
  const footerSections = [
    {
      ...
      links: [
        { name: 'Features', href: '/' },
        { name: 'Cloud Infrastructure', href: '/infrastructure' },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Powering next-generation applications with cutting-edge cloud infrastructure and
                developer tools. Trusted by over 10,000 engineering teams worldwide for
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">support@acmetech.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">
                  2100 Innovation Drive, San Francisco, CA
                </span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get platform updates, new feature announcements, and technical insights. Unsubscribe
                anytime.
              </p>
            </div>
          </div>
